    ...
    <main className="min-h-screen bg-[#F3F5F5] text-[#1C1D20] font-sans relative">
      ...
      <header className="container mx-auto max-w-4xl px-6 py-28 text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <a
            href="#signup"
            className="bg-[#316E72] text-[#F3F5F5] font-semibold px-8 py-3 rounded-xl border border-[#316E72] shadow-lg hover:brightness-110 transition-transform transform hover:scale-[1.02] cursor-pointer"
          >
        ...
        <p className="mt-6 text-sm text-[#316E72]">Beta access is limited.</p>
      </header>

      {/* Strip */}
      <section className="bg-[#D6E8E3]/10 border-y border-[#B7DFD9] py-6 text-center">
        <p className="text-[#316E72] text-base">
          <strong>
      ...
      >
        <div className="bg-[#D6E8E3]/20 border border-[#B7DFD9] rounded-2xl p-8 shadow-md">
          <h2 className="text-3xl font-semibold mb-4 text-[#316E72]">Investors</h2>
      ...
      <section className="container mx-auto max-w-5xl px-6 py-16 grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-[#D6E8E3]/20 border border-[#B7DFD9] rounded-2xl p-8 shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-[#316E72]">Accessibility</h2>
          <p className="text-sm leading-relaxed text-[#1C1D20]">
      ...
      {/* Footer */}
      <footer className="container mx-auto max-w-5xl px-6 py-8 text-sm text-[#316E72] border-t border-[#B7DFD9] flex flex-wrap justify-between gap-3">
